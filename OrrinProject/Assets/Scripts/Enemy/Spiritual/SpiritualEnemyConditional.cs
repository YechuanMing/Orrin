...
public class SpiritualEnemyConditional :Conditional
{
    ...
    public override void OnAwake()
    {
        ...
        destructable_Spirit = GetComponent<Destructable>();
        destructable_Body = gameObject.GetComponentInChildren<Destructable>();
