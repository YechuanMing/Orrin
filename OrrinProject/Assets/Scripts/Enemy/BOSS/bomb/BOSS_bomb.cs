...
public class BOSS_bomb : MonoBehaviour
{
    ...
    {
        Vector3 center = transform.position;
        GameObject bomb1 = Instantiate(BombSpirits, center + new Vector3(1f, 3f, 0), Quaternion.identity);
        GameObject bomb2 = Instantiate(BombSpirits, center - new Vector3(1f,3f, 0), Quaternion.identity);
    }
}
